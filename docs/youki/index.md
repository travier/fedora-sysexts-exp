...
See the [youki versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/youki).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component youki
```
