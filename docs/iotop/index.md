...
See the [iotop versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/iotop).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component iotop
```
