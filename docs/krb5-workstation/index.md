...
See the [krb5-workstation versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/krb5-workstation).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component krb5-workstation
```
