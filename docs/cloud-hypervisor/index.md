...
See the [cloud-hypervisor versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/cloud-hypervisor).
...
```
install_sysext cloud-hypervisor
```
</details>
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component cloud-hypervisor
```
