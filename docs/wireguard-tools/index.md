...
See the [wireguard-tools versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/wireguard-tools).
...
```
install_sysext wireguard-tools
```
</details>
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component wireguard-tools
```
