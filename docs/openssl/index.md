...
See the [openssl versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/openssl).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component openssl
```
