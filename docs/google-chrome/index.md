...
See the [google-chrome versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/google-chrome).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component google-chrome
```
