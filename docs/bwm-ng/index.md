...
See the [bwm-ng versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/bwm-ng).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component bwm-ng
```
