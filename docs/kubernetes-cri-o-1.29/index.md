...
See the [kubernetes-cri-o-1.29 versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/kubernetes-cri-o-1.29).
...
```
install_sysext kubernetes-cri-o-1.29
```
</details>
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component kubernetes-cri-o-1.29
```
