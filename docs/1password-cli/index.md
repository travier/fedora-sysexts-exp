...
See the [1password-cli versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/1password-cli).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component 1password-cli
```
