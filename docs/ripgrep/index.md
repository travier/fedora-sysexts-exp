...
See the [ripgrep versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/ripgrep).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component ripgrep
```
