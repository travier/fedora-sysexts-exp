...
See the [virtctl versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/virtctl).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component virtctl
```
