...
See the [wasmtime versions](https://github.com/travier/fedora-sysexts-exp/releases/tag/wasmtime).
...
```
sudo /usr/lib/systemd/systemd-sysupdate update --component wasmtime
```
